        ...
        <section className="relative py-6 px-6 overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="relative bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-8 border border-slate-200 shadow-xl transition-colors duration-300">
                        ...
                        {/* Code */}
                        <pre className="text-sm md:text-base text-slate-900 font-mono overflow-x-auto leading-relaxed bg-white rounded-lg p-4 border border-slate-200 shadow-sm">
