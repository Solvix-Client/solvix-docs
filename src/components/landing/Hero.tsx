            ...
            <div className="max-w-4xl mx-auto text-center w-full">
              ...
              hover:scale-105 transition-all duration-300 animate-[float_4s_ease-in-out_infinite]"
                    ...
                    <motion.h1
                        ...
                        className="text-5xl sm:text-6xl md:text-7xl font-bold mt-6 bg-gradient-to-r from-[#1FD1B2] to-[#0FA38A] bg-clip-text text-transparent"
                    >
                        Solvix
                    </motion.h1>
                </div>
                ...
                >
                    ...
                    <MotionLink
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-[#1FD1B2] to-[#0FA38A] hover:from-[#18C2A6] hover:to-[#0E8E79] text-white font-semibold px-6 py-2 text-lg rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto justify-center"
                    >
                        <Book size={18} />
                        Get Started
                    </MotionLink>
                    ...
                    <motion.a
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.97 }}
                        className="inline-flex items-center gap-2 border-2 border-gray-300 dark:border-gray-700 font-semibold px-6 py-2 text-lg rounded-lg hover:border-[#0E8E79] hover:text-[#0E8E79] transition-all duration-300 w-full sm:w-auto justify-center"
                    >
                        <Github size={18} />
                        View on GitHub
                    </motion.a>
                    ...
                    {/* <motion.a
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.97 }}
                        className="inline-flex items-center gap-2 font-medium px-6 py-4 text-lg rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-all duration-300 w-full sm:w-auto justify-center"
                    >
                        <Heart size={18} />
                        Become a Sponsor
                    </motion.a> */}
