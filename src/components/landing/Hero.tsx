              ...
              hover:scale-105 transition-all duration-300 animate-[float_4s_ease-in-out_infinite]"
                ...
                >
                    ...
                    <motion.a
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.97 }}
                        className="inline-flex items-center gap-2 border-2 border-gray-300 dark:border-gray-700 font-semibold px-8 py-2 text-lg rounded-lg hover:border-[#0E8E79] hover:text-[#0E8E79] transition-all duration-300"
                    >
                        <Github size={18} />
                        View on GitHub
                    </motion.a>
